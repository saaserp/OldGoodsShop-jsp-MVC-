...
<BODY bgColor=#ffffff onLoad="MM_preloadImages('<%=path %>/images/fh_2.jpg','<%=path %>/images/jxtj_2.jpg')">
    ...
    <TR>
      <TD vAlign=top align=right width=743 height=452><TABLE cellSpacing=0 cellPadding=0 width=556 border=0>
        ...
        <TBODY>
          ...
          <TR>
            <TD height=164 vAlign=top><IMG height=7 src="<%=path %>/images/jt.gif" width=7> <span class="foot3">数据项以正确写入！</span><span class="STYLE1"><br>
                <br>
                <br>
                <br>
                <br>
          ...
          <TR>
            <TD height=20 align="center"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image9','','<%=path %>/images/fh_2.jpg',1)"><img src="<%=path %>/images/fh_1.jpg" name="Image9" width="60" height="22" border="0"></a>&nbsp;<a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','<%=path %>/images/jxtj_2.jpg',1)"><img src="<%=path %>/images/jxtj_1.jpg" name="Image6" width="100" height="22" border="0"></a></TD>
            <TD></TD>
          </TR>
        </TBODY>
      </TABLE></TD>
