...
public class SendMail {
	...
	*/ 
	public static void send(String str_from,String str_to,String str_title,String str_content,String str_filename) { 
	...
	DataSource dataSourse=new FileDataSource(str_filename);
	message.setDataHandler(new DataHandler(dataSourse));
	String name=str_filename.substring(str_filename.lastIndexOf("\\")+1);
	...
	//测试用的，你吧你想写的内容写上去就行 
	send(Constant.mailCount,Constant.mailAddress,"随机点名成绩生成测试","<b>This is Context</b>","c:\test.xls"); 
	} 
	} 
